...
export const CATEGORIES = [
  { name: "Biodiversity", slug: "biodiversity", count: 1, icon: "Leaf", desc: "Protecting ecosystems, planting native flora, and supporting pollinators." },
  { name: "Conservation", slug: "conservation", count: 1, icon: "TreeDeciduous", desc: "Preserving forests, defending natural habitats, and nurturing soil health." },
  { name: "Climate Action", slug: "climate-action", count: 1, icon: "Flame", desc: "Reducing carbon footprints, switching to green transits, and tracking energy." },
  { name: "Sustainable Living", slug: "sustainable-living", count: 1, icon: "Droplet", desc: "Reducing single-use plastics, saving water, and living waste-free." },
];
...
const fallbackArticles: Article[] = [
  {
    ...
    keywords: ["urban biodiversity", "pollinator gardens"],
    cover: "/images/urban-biodiversity.jpg",
    content: ""
  },
  {
    slug: "forests-carbon-sinks",
    ...
    readTime: "6 Min Read",
    featured: false,
    tags: ["conservation", "carbon sink", "forestry"],
    keywords: ["carbon sink", "planting trees"],
      ...
      for (const file of files) {
        ...
        try {
          ...
          articles.push({
            ...
            author: data.author || "Earthlog Editor",
